...
namespace Parcial01BM101219.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public EstudiantesController(Bm101219Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                var bm101219Context = _context.Estudiantes.Include(e => e.Usuario);
        ...
        public async Task<IActionResult> Create([Bind("EstudianteId,Nombre,UsuarioId")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EstudianteId,Nombre,UsuarioId")] Estudiante estudiante)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Bm101219Context.Estudiantes'  is null.");
            }
            var estudiante = await _context.Estudiantes.FindAsync(id);
            if (estudiante != null)
            {
